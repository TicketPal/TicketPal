		...
		<div class="col-xl-6">
			<div class="card ticketpal-card">
				<div class="card-header">
					...
					<div class="ticketpal-card-title"> Bar Chart </div>
					<div class="ticketpal-card-menu">
						<div class="dropdown show">
							<a class="ticketpal-card-menu-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							</a>
				...
				<div class="card-body ticketpal-card-body-chart">
					<canvas id="ticketpalChartjsBar"></canvas>
					<script>
						var ctx = document.getElementById("ticketpalChartjsBar").getContext('2d');
		...
		<div class="col-xl-6">
			<div class="card ticketpal-card">
				<div class="card-header">
					...
					<div class="ticketpal-card-title"> Notifications </div>
				</div>
				<div class="card-body ">
